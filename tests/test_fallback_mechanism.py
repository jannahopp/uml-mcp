...
def test_fallback_plantuml_success(mock_kroki_failure, mock_plantuml_fallback, tmp_path):
...
def test_fallback_not_triggered_on_success(tmp_path):
    ...
    with patch("mcp_core.core.utils.get_kroki_client", return_value=mock_client), \
         patch("mcp_core.core.utils._generate_diagram_plantuml_fallback") as mock_fallback:
